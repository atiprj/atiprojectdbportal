...
export const projectConfig = {
  ...
  externalLinks: {
    ...
    ifcModels: [
      {
        ...
        url: "/models/000001_FTE_00_000_ARC_PIM_000.frag", // Percorso relativo alla cartella public
    ...
    {
      id: "ifc-model-infissi",
      name: "Modello Infissi",
      description: "Modello IFC di porte, finestre e altri infissi",
      url: "/models/000001_FTE_00_000_ARC_INFISSI.frag",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["infissi", "porte", "finestre", "BIM"],
    },
    {
      id: "ifc-model-muri",
      name: "Modello Muri",
    ...
    {
      id: "ifc-model-pavimenti",
      name: "Modello Pavimenti",
      description: "Modello IFC dei pavimenti interni ed esterni",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_PAVIMENTI.frag",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["pavimenti", "BIM"],
    },
    {
      id: "ifc-model-scale",
      name: "Modello Scale",
      description: "Modello IFC delle scale interne ed esterne",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_SCALE.frag",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["scale", "BIM"],
    },
    {
      id: "ifc-model-tetti",
      name: "Modello Tetti",
      description: "Modello IFC della copertura e delle strutture di copertura",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_TETTI.frag",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["tetti", "copertura", "BIM"],
    },
    {
      id: "ifc-model-rooms",
      name: "Modello Stanze",
      description: "Definizione dei locali interni in formato fragment",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_ROOMS.frag",
      type: "frag",
      category: "Architettura",
      visible: true,
      tags: ["stanze", "locali", "BIM"],
    },
