...
export const projectConfig = {
  ...
  externalLinks: {
    ...
    ifcModels: [
      ...
      {
      id: "ifc-model-doors-win",
      name: "Modello Porte e Finestre",
      description: "Modello IFC di porte e finestre dell'edificio",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_DOORS&WIN.ifc",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["porte", "finestre", "BIM"],
    },
    {
      id: "ifc-model-floors",
      name: "Modello Pavimenti",
      description: "Modello IFC dei pavimenti dell'edificio",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_FLOORS.ifc",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["pavimenti", "BIM"],
    ...
    {
      id: "ifc-model-roof",
      name: "Modello Coperture",
      description: "Modello IFC della copertura dell'edificio",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_ROOF.ifc",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["copertura", "tetto", "BIM"],
    },
    {
      id: "ifc-model-stairs",
      name: "Modello Scale",
      description: "Modello IFC delle scale interne ed esterne",
      url: "/models/000001_FTE_00_000_ARC_PIM_000_STAIRS.ifc",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["scale", "BIM"],
    },
    {
      ...
      url: "/models/000001_FTE_00_000_ARC_PIM_000_WALL.ifc",
      type: "ifc",
      category: "Architettura",
      visible: true,
      tags: ["muri", "BIM"],
